class Hall_Window_Guizu extends eui.Component implements  eui.UIComponent {

	public static _NAME:string = "Hall_Window_Guizu";
	...
	protected childrenCreated():void
	{
		...
		egret.log("道具列表3="+GlobalData.GetInstance().itemArr.length);
		this._DataArr = RES.getRes("Gift_json");
		...
		this._list.itemRenderer = Hall_Window_Guizu_Good;
	}
